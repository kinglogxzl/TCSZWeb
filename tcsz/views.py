...
def commodity(request):
    ...
    context['cont'] = [
        {
            'src1': '/static/img/伴手礼/1.jpg',
            'src2': '/static/img/伴手礼/2.jpg',
            'name': '帝师客居宅',
...
def notice_detail(request, name):
    ...
    notice_list = {
        ...
        '文旅部、国家卫健委联合下发《通知》 严格规范景区管理': [
            {"img": '/static/img/activity/tz.jpg',
            ...
            {"img": '/static/img/activity/tz2.png',
        ...
        '旅游景区接待游客量不得超过核定最大承载量的30%...': [
            {"img": '/static/img/activity/cw1.jpg',
            ...
            {"img": '/static/img/activity/cw2.jpg',
        ...
        '关于进一步加强公共场所新冠肺炎疫情防控工作的通告...': [
            {"img": '/static/img/activity/tg1.jpg',
            ...
            {"img": '/static/img/activity/tg2.bmp',
             "p": [
        ...
        '关于应对新冠肺炎疫情影响加快服务业发展的工作方案...': [
            ...
            {"img": '/static/img/activity/tg2.png',
             "p": [
