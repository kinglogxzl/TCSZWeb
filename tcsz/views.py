...
def activity(request):
    ...
    context['cont'] = [
        {
            'src1': '/static/img/activity/1.jpg',
        ...
        {
            'src1': '/static/img/activity/2.jpg',
            'name': '第四届河北省旅游产业发展大会 观摩活动在我县陶瓷水镇南横口举行',
            'name1': '陶瓷水镇',
            'name2': '井陉南横口',
            'name3': '旅游发展大会',
            'time': '2019.10.16',
        ...
        {
            'src1': '/static/img/activity/4.jpg',
...
def play(request):
    ...
    context['cont'] = [
        {
            'src1': '/static/img/娱乐/tc1.jpg',
            'src2': '/static/img/娱乐/tc2.jpg',
            'name': '陶瓷体验馆',
...
def play_detail(request, name):
    ...
    play_list = {
        '陶瓷体验馆': [
            {"img": '/static/img/娱乐/tc1.jpg',
             "p": ['在优雅古朴环境里，伴着悠扬的音乐，放松精神，仿佛置身世外桃源，来体验制作陶瓷']
             },
            {"img": '/static/img/娱乐/tc2.jpg',
...
def activity_detail(request, name):
    ...
    activity_list = {
        ...
        '第四届河北省旅游产业发展大会 观摩活动在我县陶瓷水镇南横口举行': [
             {"img": '/static/img/activity/GMHD.jpg',
             "p": ['10月15日上午9时，第四届河北省旅游产业发展大会在石家庄国际会展中心开幕。10月16日上午旅发观摩团分两批来到井陉县陶瓷水镇南横口进行观摩。观摩团队按预定路线从东广场开始观摩。']
             },
            {"img": '/static/img/activity/GMHD1.jpg',
            "p": ['景区湖内，画舫悠悠，小船划过。画舫上两位美女分别用古筝、二胡弹奏起优美的《茉莉花》，众多游客的眼球被眼前这美景和她们奏出悠扬的旋律所吸引。仙境一般的陶瓷体验馆院内，是观摩团此次景区观摩的最后一个景点。大家表示没想到井陉还有这么好的地方。“闲暇之余我一定带我的家人到此好好转转，特色民宿住上一晚，体验一番”一位成员说到。其实这句话是对陶瓷水镇最大的肯定，相信陶瓷水镇的明天会越来越好！']
             }],
        '陶瓷水镇新貌即将亮相石家庄第五届旅发大会': [
            {"img": '/static/img/activity/JJLX.jpg',
             "p": [
            ...
            {"img": '/static/img/activity/JJLX1.jpg',
             "p": [
        ...
        '陶瓷水镇红色文化主题展馆举行开展仪式': [
            {"img": '/static/img/activity/HSWH.jpg',
             "p": [
            ...
            {"img": '/static/img/activity/HSWH1.jpg',
             "p": [
        ...
        '曾经杭州西湖断桥爱情美，如今河北陶瓷水镇迎恋情': [
            {"img": '/static/img/activity/XQH.jpg',
             "p": [
            ...
            {"img": '/static/img/activity/XQH1.jpg',
             "p": [
