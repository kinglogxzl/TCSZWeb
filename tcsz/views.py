...
def activity(request):
    ...
    context['cont'] = [
        {
            'src1': 'http://image.taocishuizhen.com/activity/syds.jpg',
            'name': '2020年中国•陶瓷水镇“南横口杯”首届全国摄影大赛公告',
            'name1': '南横口杯',
            'name2': '摄影大赛',
            'name3': '陶瓷水镇',
            'time': '2020.5.25',
            'intro': ' 为了宣传“井陉窑”文化，展现陶瓷水镇的灵魂、浓厚的人文、全域美景，多方位推进“井陉窑”文化旅游目的地建设，特举办“南横口杯”全国摄影大赛。欢迎广大摄影工作者和摄影爱好者踊跃投稿，积极参与。 '
        },
        {
        ...
        {
            'src1': 'http://image.taocishuizhen.com/activity/61.jpg',
            'name': '六一儿童节快乐|缤纷六月，七彩童年',
            'name1': '陶瓷水镇',
            'name2': '六一儿童节',
            'name3': '石家庄井陉',
            'time': '2020.5.31',
            'intro': ' 童年，是一幅迷人的画勾勒出我多少动人有趣的故事童年，是一首婉转悠扬的短笛奏出了我多少纯洁美好的幻想走进欢乐的6.1儿童节和孩子们一起回归童真 '
        },
        {
...
def notice_detail(request, name):
    ...
    notice_list = {
        ...
        '关于进一步加强公共场所新冠肺炎疫情防控工作的通告...': [
            ...
            {"img": 'http://image.taocishuizhen.com/activity/tg2.jpg',
             "p": [
...
def activity_detail(request, name):
    ...
    context['title2'] = '更多活动'
    activity_list = {
        '2020年中国•陶瓷水镇“南横口杯”首届全国摄影大赛公告': [
            {"img": 'http://image.taocishuizhen.com/activity/syds.jpg',
             "p": ['由河北华秀文化旅游有限公司和河北井陉窑文化研究会主办，石家庄广播电视摄影协会、河北省女摄影家协会和河北省航拍学会第八大队协办的“2020年中国•陶瓷水镇“南横口杯”首届全国摄影大赛”于2020年6月1日启动。为了宣传“井陉窑”文化，展现陶瓷水镇的灵魂、浓厚的人文、全域美景，多方位推进“井陉窑”文化旅游目的地建设，特举办“南横口杯”全国摄影大赛。欢迎广大摄影工作者和摄影爱好者踊跃投稿，积极参与。']
             },
            {"img": 'http://image.taocishuizhen.com/activity/lf1.jpg',
             "p": [
                 ' 一、摄影大赛时间:2020年6月1日至8月31日24时止。二、摄影地点井陉县南横口陶瓷水镇。三、参赛人员全国摄影工作者和爱好者均可参加。凡是参赛人员，凭身份证到“陶瓷水镇”游客中心登记，领取参赛证。参赛期间，凭参赛证享有免费拍摄权利。联系电话：82393999。四、拍摄内容围绕井陉县南横口陶瓷水镇，以“井陉窑”陶瓷文化、红色教育基地、中国传统古村落三大文化灵魂为主题，将文化与旅游两大产业融合，开启新模式，塑造新思维。拍摄题材以纪实为主，全面展现本次大赛主题的风貌。']
             },
            {
             "p": [
                 '五、图片要求拍摄图片须是2019年1月1日以来的作品（未获得任何奖项作品）。图片彩色、黑白及单幅、组照均可，组照每组4-8张。图片只可在饱和度、色阶、对比度、明暗等进行调整。谢绝创意、电脑合成及任意添加或删减，需保证图片的真实性和完整性。图片为JPG电子格式，像素不小于3M。六、提交作品要求提交作品时，一位作者需建一个文件夹打包上传，文件夹名称标明：“南横口杯”摄影大赛+姓名+联系电话。文件夹内的组照和单幅作品，只写作品名称。文件夹内附文档，每幅作品须有简短说明，包括创作时间和内容。不按要求提交作品的视为无效稿件。七、参赛作品提交时间2020年6月1日至8月31日24时止。每人限交10幅（组）作品。八、提交作品邮箱taocishuizhenly@163.com']
             },
            {
                "p": [
                    '九、奖项设置（等次奖项不可重复获得）一等奖1名，奖金5000元（税后）；二等奖3名，奖金各3000元（税后）；三等奖5名，奖金各1000元（税后）；优秀奖20名，奖金各200元（税后）。获奖后，作者按照要求提交原始文件，未提交的，取消获奖资格。作者须享有提交作品的版权，如有版权纠纷，作者自负，与主办方无关。主办方享有所有参赛作品的使用权，主办方有权在宣传、影展中使用。影赛公告及获奖信息在www.taocishuizhen.com（陶瓷水镇旅游官方网站）、河北省女摄协公众号和广电摄协公众号及各大摄影微信群、QQ群刊登。温馨提示：摄影师在拍摄创作时，注意自身安全，如遇问题，责任自负。组织者有协助救助义务，但不承担任何法律责任。凡参赛者均视为同意以上条款，大赛主办方享有最终解释权。  ']
            },
        ],
        ...
        '六一儿童节快乐|缤纷六月，七彩童年': [
            {"img": 'http://image.taocishuizhen.com/activity/611.jpg',
             "p": [
                 '童年，是一幅迷人的画勾勒出我多少动人有趣的故事童年，是一首婉转悠扬的短笛奏出了我多少纯洁美好的幻想 ，走进欢乐的6.1儿童节和孩子们一起回归童真']
             },
            {"img": 'http://image.taocishuizhen.com/activity/61.jpg',
             "p": [
                 '亲子游，大朋友小朋友过欢喜！完美的亲子游，放下手机，放下工作，陪伴孩子渡过一个快乐的六一！']
             }],
        '陶瓷水镇红色文化主题展馆举行开展仪式': [
